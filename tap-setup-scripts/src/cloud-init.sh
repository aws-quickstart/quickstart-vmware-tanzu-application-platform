...
curl --retry 5 -o ./kubectl "https://amazon-eks.s3.${AWS_REGION}.amazonaws.com/amazon-eks/${AwsKubectlVersion}/bin/linux/$arch/kubectl"
curl --retry 5 -o ./kubectl.sha256 "https://amazon-eks.s3.${AWS_REGION}.amazonaws.com/amazon-eks/${AwsKubectlVersion}/bin/linux/$arch/kubectl.sha256"
